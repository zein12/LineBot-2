	...
	foreach ($events['events'] as $event) {
		if ($event['type'] == 'message' && $event['message']['type'] == 'text') {
			...
			if(strpos($text, 'text') !== false){
				...
				$MessageBuilder = new \LINE\LINEBot\MessageBuilder\TemplateMessageBuilder('this is a confirm template',new \TemplateBuilder('confirm','Are you Sure',('message','Yes','yes')));
				$response = $bot->pushMessage($mid, $MessageBuilder);
			}
			else{
